...
module.exports = function GhostAdminAPI(options) {
    ...
    function getFormData(data,z) {
        let formData;
        z.console.log("FORM DATA PROTO @ getFormData", Object.getPrototypeOf(data));
        /*
        if (data instanceof FormData) {
            return data;
        }
    ...
    api.images = {
        upload(data,z) {
            ...
            let testFD = new FormData;
            let getProtoTest = Object.getPrototypeOf(data) == Object.getPrototypeOf(testFD);
            z.console.log("Get Proto Test @upload", getProtoTest);
            z.console.log("is Proto of check @upload", data.isPrototypeOf(FormData));
            z.console.log("FORM DATA PROTO @upload", Object.getPrototypeOf(data));
            z.console.log("API INSTANCE OF CHECK", data instanceof FormData);
            /*
            ...
            */
            ...
            let formData = getFormData(data,z);
